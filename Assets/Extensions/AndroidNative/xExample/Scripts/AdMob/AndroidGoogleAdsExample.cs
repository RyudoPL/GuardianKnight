...
public class AndroidGoogleAdsExample : MonoBehaviour {
	...
	private static AndroidGoogleAdsExample instance;
	...
	private const string MY_BANNERS_AD_UNIT_ID		 = "ca-app-pub-6511296857869726/9860205094";
	private const string MY_INTERSTISIALS_AD_UNIT_ID =  "ca-app-pub-6511296857869726/6627537098";
	...
	private GoogleMobileAdBanner banner3;
	...
	void Awake () 
	{
		...
		DontDestroyOnLoad (this);//aby nie skasowac tego skryptu przy ladowaniu kolejnej sceny
	...
	void Start() {
		...
		AndroidAdMobController.instance.AddTestDevice("F8162CB1D340AC4905C197569A4AE244");
		...
		CreateBanner2BottomCenter();
		CreateBanner3BottomCenter();
	}
	...
	public void CreateBanner2BottomCenter()
	{
		banner2 = AndroidAdMob.Client.CreateAdBanner(TextAnchor.LowerCenter,GADBannerSize.BANNER);
		banner2.ShowOnLoad = false;
	}

	public void CreateBanner3BottomCenter()
	{
		banner3 = AndroidAdMob.Client.CreateAdBanner(TextAnchor.LowerCenter,GADBannerSize.BANNER);
		banner3.ShowOnLoad = false;
	}
