...
public class PlayServiceExample : AndroidNativeExampleBase {
	...
	//example
	private const string LEADERBOARD_NAME = "leaderboard_high_scores";
	...
	//example
	private const string LEADERBOARD_ID = "CgkIkti4j78fEAIQAQ";
	...
	void Start() {
		...
		achievementsButton = GameObject.Find("Achievements").GetComponent<Button>();
		leaderboardsButton = GameObject.Find("Leaderboards").GetComponent<Button>();
	}
	...
	private void SendInvitation() {
		GP_AppInviteBuilder builder =  new GP_AppInviteBuilder("Guardian Knight");
		builder.SetMessage("Do you think you can beat me in Guardian Knight?");
		builder.SetDeepLink("https://www.facebook.com/JollyGoatGames/");
		builder.SetCallToActionText("Stand your guard!");
