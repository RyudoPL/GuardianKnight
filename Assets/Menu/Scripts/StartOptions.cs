...
public class StartOptions : MonoBehaviour {
	...
	void Awake()
	{
		...
		playMusic = GameObject.Find("MusicManager").GetComponent<PlayMusic> ();

		showPanels.HideEquipmentPanel();
	}

	public void StartButtonClicked(int level)
	{
		Camera.main.backgroundColor = Color.black;
		GameObject.Find("KnightMenu").SetActive(false);
	...
	public void LoadDelayed(int level)
	{
